<!--文章详情内容部分-->
<template>
  <div class="details-body" :class="{'is-fixed-top':isFixedTop}">
      ...
      <div class="details-body-head-content">
        ...
        <div class="details-body-head-content-right">
          <div class="details-body-head-content-right-item">
            ...
            <span class="details-body-head-content-right-item-text">234111</span>
          </div>
          <div class="details-body-head-content-right-item">
            <span class="details-body-head-content-right-item-til">被浏览</span>
            <span class="details-body-head-content-right-item-text">4532666</span>
          </div>
        </div>
      </div>
